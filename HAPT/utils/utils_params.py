...
def gen_run_folder(path_model_id='', force_create_new=False):
    run_paths = dict()

    if not os.path.isdir(path_model_id) or force_create_new:
        path_model_root = os.path.abspath(os.path.join(os.path.dirname(__file__), os.pardir, os.pardir, 'HAPT_experiments'))
